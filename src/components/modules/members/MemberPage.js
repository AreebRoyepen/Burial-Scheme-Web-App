    ...
    const sendRequest = useCallback(async () => {
      ...
      async function updateMember(){
        ...
        if(location.state.edit){
          ...
          let resp = await Api.putRequest("v1/members/"+location.state.x.id, member)
          console.log(resp)
...
<form className="form ">
    ...
    <div>
		...
		<input required type="text" className="form__input inputValText" name="text" placeholder="Name" pattern="^\D*$"  value = {member.name}
    ...
    <div>
		...
		<input required type="text" className="form__input inputValText" name="text" placeholder="Surname" pattern="^\D*$"  value = {member.surname}
    ...
    <div>
		...
		<input required type="text" className="form__input inputValText" name="text" placeholder="Address" pattern="^\D*$"  value = {member.address}
    ...
    <div>
		...
		<input required type="text" className="form__input inputValText" name="text" placeholder="Area" pattern="^\D*$"  value = {member.area}
    ...
    <div>
		...
		<input required type="text" className="form__input inputValText" name="text" placeholder="Postal Code" pattern="^\D*$"  value = {member.postalCode}
        onChange={ e => setMember({...member,postalCode : e.target.value})} />
		<div className="form__requirements">
    ...
    <div>
		...
		<input required type="text" className="form__input inputValText" name="text" placeholder="ID Number" pattern="^\D*$"  value = {member.idnumber}
    ...
    <div>
		...
		<input required type="tel" className="form__input inputValText" name="text" placeholder="Cell Number"  pattern="[0-9a-zA-Z]{10,}" maxLength="10" value = {member.cellNumber}
        onChange={ e => setMember({...member,cellNumber : e.target.value})} />
		<div className="form__requirements">
    ...
    <div>
		...
		<input required type="tel" className="form__input inputValText" name="text" placeholder="Work Number"  pattern="[0-9a-zA-Z]{10,}" maxLength="10" value = {member.workNumber}
        onChange={ e => setMember({...member,workNumber : e.target.value})} />
		<div className="form__requirements">
    ...
    <div>
		...
		<input required type="tel" className="form__input inputValText" name="text" placeholder="Home Number"  pattern="[0-9a-zA-Z]{10,}" maxLength="10" value = {member.homeNumber}
        onChange={ e => setMember({...member,homeNumber : e.target.value})} />
		<div className="form__requirements">
     ...
     <div>
		...
		<input required type="email" className="form__input inputValEmail" name="email" placeholder="example@aol.com"  value = {member.email}
    ...
    <div>
		...
		<input required type="text" className="form__input inputValText" name="text" placeholder="" pattern="^\D*$"  value = {member.dob}
    ...
    <div>
		...
		<input required type="text" className="form__input inputValText" name="text" placeholder="" pattern="^\D*$"  value = {member.doe}
                ...
                <Grid component="label" container alignItems="center" spacing={1}>
                  ...
                  <Grid item>
                    ...
                    <Switch
                      ...
                      onChange={e => setMember({...member,paidJoiningFee : e.target.checked})}
                      //color="#08533C"
                    />
...
<div  className="btn-group">
   ...
   {location.state.edit ?             
        ...
        <button 
        //id = {validateForm()} 
        className = "button" type="button" disabled={isSending} onClick={sendRequest} > Edit Member</button>
      :
      
      <button 
      //id = {validateForm()} 
      className = "button" type="button" disabled={isSending} onClick={sendRequest } > Add Member</button>
      }
